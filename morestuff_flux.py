#curve fit
#look at chi squared, and use BIC to test how good is it, look for chi less than 10
import numpy as np
...
def gaus(x, a, b, x0, sigma):
    ...
    """
    return 1 * a * np.exp(-(x - x0)**2 / (2 * sigma**2)) + b



def aflare1(t, ampl, offset, tpeak, fwhm, upsample=False, uptime=10):
    '''
    ...
    if upsample:
        ...
        #add the negative sign because working with mag, not flux
